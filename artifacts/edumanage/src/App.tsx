...
const DeliberationAnnuellePage = lazy(() => import("@/pages/admin/DeliberationAnnuellePage"));
...
const TeacherModulesPage = lazy(() => import("@/pages/teacher/TeacherModulesPage"));
...
const TeacherCahierFormPage = lazy(() => import("@/pages/teacher/TeacherCahierFormPage"));
...
function AppRouter() {
  return (
    <Switch>
      ...
      <Route path="/admin/deliberations-annuelles">
        <Admin><DeliberationAnnuellePage /></Admin>
      </Route>
      ...
      <Route path="/teacher/cahier/nouveau">
        <Teacher><TeacherCahierFormPage /></Teacher>
      </Route>
      <Route path="/teacher/cahier/:id/edit">
        {(p) => <Teacher><TeacherCahierFormPage id={p.id} /></Teacher>}
      </Route>
