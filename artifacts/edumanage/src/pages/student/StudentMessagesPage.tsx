...
function roleLabel(u: UserAccountRecord): string {
  ...
  return u.role === "teacher" ? "Enseignant" : "Administration";
}
  ...
  return (
    <div className="space-y-4">
      <div className="rounded-2xl border border-border bg-card p-5">
        ...
        <p className="text-sm text-muted-foreground mt-1">Communiquez avec l'administration et vos enseignants.</p>
      </div>
      ...
      <FormModal open={showNewMessage} onClose={() => setShowNewMessage(false)} title="Nouveau message" subtitle="Contactez un membre de l'administration ou un enseignant">
