...
export const ADMIN_WIP_PAGES: Record<string, AdminWipPage> = {
  ...
  "prof-rallonge": { title: "Demande de rallonge volume horaire", section: "Professeurs" },
  "prof-absence": { title: "Absence", section: "Professeurs" },
  "prof-retard": { title: "Retard", section: "Professeurs" },
  ...
  "fin-pec-export": { title: "Export comptable", section: "Finances · Prise en charge" },
  "fin-pec-derogation": { title: "Dérogation des paiements", section: "Finances · Prise en charge" },
